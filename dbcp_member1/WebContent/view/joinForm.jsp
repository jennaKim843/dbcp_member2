			...
			<div class="form-group row justify-content-center">
				...
				<div class="col-sm-6">
					<input type="text" name="userid" id="userid" class="form-control"
						placeholder="아이디를 입력하세요" /> <small id="userid" class="text-info"></small>
				</div>
			</div>
			<div class="form-group row justify-content-center">
				...
				<div class="col-sm-6">
					<input type="password" name="password" id="password"
						class="form-control" placeholder="비밀번호를 입력하세요" /> <small
			...
			<div class="form-group row justify-content-center">
				...
				<div class="col-sm-6">
					<input type="password" name="confirm_password"
						...
						placeholder="비밀번호를 다시 입력하세요" /> <small id="confirm_password"
			...
			<div class="form-group row justify-content-center">
				...
				<div class="col-sm-6">
					<input type="text" name="name" id="name" class="form-control"
						placeholder="이름을 입력하세요" /> <small id="name" class="text-info"></small>
				</div>
			</div>
			<div class="form-group row justify-content-center">
			...
			<div class="form-group row justify-content-center">
				...
				<div class="col-sm-6">
					<input type="email" name="email" id="email" class="form-control"
						placeholder="example@gmail.com" /> <small id="email"
						class="text-info"></small>
				</div>
			</div>
